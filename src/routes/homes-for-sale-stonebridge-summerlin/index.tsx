...
export const head: DocumentHead = {
	title:
		"Homes for Sale in Stonebridge, Summerlin, Las Vegas NV | Dr. Jan Duffy",
	meta: [
		{
			name: "description",
			content:
		...
		},
		{
			property: "og:url",
			content:
				"https://heritagestonebridge.com/homes-for-sale-stonebridge-summerlin",
		},
		{
			property: "og:image",
			content:
			...
			<section class="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-20">
				...
				<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p class="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto">
						Discover luxury living in Stonebridge, Summerlin's premier gated
						community. Resort-style amenities, mountain views, and active adult
						lifestyle await.
					</p>
				...
				<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div class="text-center mb-12">
						...
						<p class="text-xl text-gray-600 max-w-3xl mx-auto">
							Stonebridge offers the perfect blend of luxury living, resort
							amenities, and prime Summerlin location for discerning homebuyers.
						</p>
					</div>
					...
					<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						<div class="bg-white p-6 rounded-lg shadow-lg">
							<div class="text-center">
								...
								<p class="text-gray-600">
									24/7 gated access with professional security ensuring privacy
						...
						<div class="bg-white p-6 rounded-lg shadow-lg">
							<div class="text-center">
								...
								<p class="text-gray-600">
									Clubhouse, swimming pools, fitness center, pickleball courts,
									and walking trails for active living.
								</p>
							</div>
						</div>
						...
						<div class="bg-white p-6 rounded-lg shadow-lg">
							<div class="text-center">
								...
								<p class="text-gray-600">
									Minutes from Red Rock Canyon, Downtown Summerlin, and
			...
			<section class="py-16 bg-white">
				<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div class="text-center mb-12">
						...
						<p class="text-xl text-gray-600 max-w-3xl mx-auto">
							Explore our curated selection of luxury homes currently available
							in the Stonebridge community.
						</p>
					</div>
					...
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p class="text-lg text-gray-600 mb-6">
								Stonebridge is perfectly positioned in Summerlin West, offering
								unparalleled access to Las Vegas's finest attractions and
								amenities.
							</p>
			...
			<section class="py-16 bg-white">
				<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div class="text-center mb-12">
						...
						<p class="text-xl text-gray-600 max-w-3xl mx-auto">
							Stay informed about the latest market trends and property values
							in Stonebridge, Summerlin.
						</p>
					</div>
				...
				<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
					<div class="text-center mb-12">
						...
						<p class="text-xl text-gray-600">
							Everything you need to know about buying a home in Stonebridge,
							Summerlin.
						</p>
					</div>
					...
					<div class="space-y-6">
						<div class="bg-white p-6 rounded-lg shadow-lg">
							...
							<p class="text-gray-600">
								Stonebridge offers three distinct home collections: Cromwell
								(1,232-1,456 sq ft), Stirling (1,456-2,100 sq ft), and Evander
								(2,100-2,873 sq ft). All homes feature single-story living with
								luxury finishes and resort-style amenities.
							</p>
						</div>
						...
						<div class="bg-white p-6 rounded-lg shadow-lg">
							...
							<p class="text-gray-600">
								Yes, Stonebridge is a fully gated community with 24/7 security
								and controlled access. This ensures privacy and peace of mind
								for all residents.
							</p>
						</div>
						...
						<div class="bg-white p-6 rounded-lg shadow-lg">
							...
							<p class="text-gray-600">
								Residents enjoy access to a clubhouse, swimming pools, fitness
								center, pickleball courts, walking trails, parks, and gardens.
								The community is designed for active adult living with
						...
						<div class="bg-white p-6 rounded-lg shadow-lg">
							...
							<p class="text-gray-600">
								Stonebridge is located just 12 miles from Red Rock Canyon
								National Conservation Area, making it easy to enjoy hiking, rock
								climbing, and scenic drives in this natural wonder.
							</p>
						</div>

						<div class="bg-white p-6 rounded-lg shadow-lg">
							<h3 class="text-xl font-semibold mb-3">
								What is the HOA fee for Stonebridge homes?
							</h3>
							<p class="text-gray-600">
								The HOA fee for Stonebridge homes is approximately $410 per
								month, which includes maintenance of common areas, security, and
			...
			<section class="py-16 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
				<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p class="text-xl text-blue-100 mb-8">
						Let Dr. Jan Duffy help you discover the perfect home in Stonebridge,
						Summerlin. With years of experience and local expertise, she'll
