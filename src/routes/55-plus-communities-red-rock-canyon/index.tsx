		...
		<>
				...
				<div class="relative max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto">
							Discover luxury active adult living at Heritage at Stonebridge, Summerlin's most prestigious 55+ community. 
							Experience resort-style amenities, gated security, and breathtaking Red Rock Canyon views.
						</p>
					...
					<div class="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p class="text-lg text-gray-700 mb-6">
								...
								As one of the most sought-after active adult communities near Red Rock Canyon, 
								our gated community offers an unparalleled lifestyle for discerning homeowners.
							</p>
							<div class="space-y-4">
								<div class="flex items-start">
									...
									<div>
										...
										<p class="text-gray-600">Three distinct collections: Cromwell, Stirling, and Evander</p>
									</div>
								</div>
								<div class="flex items-start">
									<div class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-4 mt-1">
									...
									<div>
										...
										<p class="text-gray-600">24/7 security with controlled access and professional monitoring</p>
									</div>
								</div>
								<div class="flex items-start">
									<div class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-4 mt-1">
									...
									<div>
										...
										<p class="text-gray-600">8,000 sq ft clubhouse, pickleball courts, pools, and fitness center</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							...
							of natural beauty and urban convenience, making it one of the most desirable 
							55+ communities near Red Rock Canyon Las Vegas.
						</p>
					</div>
					...
					<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div class="bg-white rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-600 mb-4">Just 15 minutes to world-famous Red Rock Canyon National Conservation Area</p>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-600 mb-4">Premium shopping, dining, and entertainment at Downtown Summerlin</p>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-600 mb-4">Multiple hospitals and medical centers within 10 minutes</p>
					...
					<div class="mt-12">
						<div class="bg-white rounded-xl p-6 shadow-lg">
							<h3 class="text-2xl font-bold text-gray-900 mb-4 text-center">Heritage at Stonebridge Location Map</h3>
							...
							<div class="mt-4 text-center text-gray-600">
								<p><strong>Address:</strong> 12345 Stonebridge Drive, Las Vegas, NV 89134</p>
								<p><strong>Neighborhood:</strong> Summerlin West, Stonebridge Village</p>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="py-16 bg-white">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Heritage at Stonebridge offers three carefully designed home collections, each tailored 
							to different lifestyles and preferences. From intimate single-story designs to spacious 
							luxury estates, find your perfect 55+ home for sale in Summerlin.
						</p>
					</div>
					...
					<div class="grid lg:grid-cols-3 gap-8">
						...
						<div class="bg-gray-50 rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-700 mb-4">
								Perfect for those seeking intimate, low-maintenance living with modern amenities 
						...
						<div class="bg-gray-50 rounded-xl p-6 shadow-lg border-2 border-blue-200">
							...
							<p class="text-gray-700 mb-4">
								The perfect balance of space and luxury, featuring open-concept designs and 
						...
						<div class="bg-gray-50 rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-700 mb-4">
								Ultimate luxury living with expansive layouts, premium features, and 
				...
				<div class="max-w-7xl mx-auto px-4">
					...
					<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">Spacious gathering areas, meeting rooms, and event spaces for community activities</p>
						</div>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">Multiple courts for America's fastest-growing sport among active adults</p>
						</div>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">Heated pool with cabanas, spa, and poolside relaxation areas</p>
						</div>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">Quiet reading spaces and entertainment areas for socializing</p>
						</div>
					...
					<div class="bg-white rounded-xl p-8 shadow-lg">
						<h3 class="text-2xl font-bold text-gray-900 mb-6 text-center">Active Adult Lifestyle Programs</h3>
			...
			<section class="py-16 bg-white">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Heritage at Stonebridge represents not just a lifestyle choice, but a smart real estate 
							investment in one of Las Vegas's most desirable and stable markets.
						</p>
					</div>
					
					<div class="grid lg:grid-cols-2 gap-12">
						<div>
							<h3 class="text-2xl font-bold text-gray-900 mb-6">Summerlin Real Estate Market Performance</h3>
							<div class="space-y-6">
								<div class="bg-green-50 border-l-4 border-green-500 p-6">
									...
									<p class="text-gray-700 mb-2">Summerlin properties have shown consistent appreciation over the past decade:</p>
								...
								<div class="bg-blue-50 border-l-4 border-blue-500 p-6">
									...
									<p class="text-gray-700 mb-2">Active adult communities command premium pricing:</p>
									<ul class="text-gray-700 space-y-1">
								...
								<div class="bg-purple-50 border-l-4 border-purple-500 p-6">
									...
									<p class="text-gray-700 mb-2">Heritage at Stonebridge's location offers unique benefits:</p>
									<ul class="text-gray-700 space-y-1">
			...
			<section class="py-16 bg-gray-50">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Heritage at Stonebridge is perfectly positioned within Stonebridge Village, 
							offering easy access to world-class amenities, entertainment, and services 
							that make Summerlin West one of Las Vegas's most sought-after areas.
						</p>
					</div>
					...
					<div class="mt-12 bg-white rounded-xl p-8 shadow-lg">
						<h3 class="text-2xl font-bold text-gray-900 mb-6 text-center">Transportation & Accessibility</h3>
						<div class="grid md:grid-cols-2 gap-8">
							<div>
			...
			<section class="py-16 bg-white">
				<div class="max-w-4xl mx-auto px-4">
					...
					<div class="space-y-6">
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">What is the minimum age for Heritage at Stonebridge?</h3>
							<p class="text-gray-700">
								Heritage at Stonebridge is designed for active adults aged 55 and older. At least one resident 
								in each household must be 55 or older, while spouses or partners can be 45 or older. 
								This age restriction ensures a community of like-minded individuals seeking an active adult lifestyle.
							</p>
						</div>
						
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">How much do homes cost at Heritage at Stonebridge?</h3>
							<p class="text-gray-700 mb-3">
								Home prices at Heritage at Stonebridge vary by collection and floor plan:
							</p>
							<ul class="text-gray-700 space-y-1 ml-4">
								<li>• <strong>Cromwell Collection:</strong> Starting from $650,000</li>
								<li>• <strong>Stirling Collection:</strong> Starting from $750,000</li>
								<li>• <strong>Evander Collection:</strong> Starting from $850,000</li>
							</ul>
							<p class="text-gray-700 mt-3">
								Prices include premium finishes, energy-efficient features, and access to all community amenities.
							</p>
						</div>
						
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">What amenities are included in Heritage at Stonebridge?</h3>
							<p class="text-gray-700 mb-3">
						...
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">Is Heritage at Stonebridge a gated community?</h3>
							<p class="text-gray-700">
						...
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">What is the HOA fee and what does it include?</h3>
							<p class="text-gray-700 mb-3">
								The total monthly HOA fee is $410, which includes:
							</p>
							<ul class="text-gray-700 space-y-1 ml-4">
						...
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">How close is Heritage at Stonebridge to Red Rock Canyon?</h3>
							<p class="text-gray-700">
								Heritage at Stonebridge is located just 12 miles (approximately 15 minutes) from 
								Red Rock Canyon National Conservation Area. This proximity allows residents to easily 
								enjoy hiking, rock climbing, scenic drives, and the natural beauty of one of Nevada's 
								most iconic landscapes.
							</p>
						</div>
						
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">When will Heritage at Stonebridge be completed?</h3>
							<p class="text-gray-700">
								Heritage at Stonebridge is scheduled for completion in 2025. The community will feature 
								421 luxury homes across 50 acres, with construction progressing in phases. Early buyers 
								can secure their preferred lot locations and customize their homes with premium finishes 
								and upgrades.
							</p>
						</div>
						
						<div class="bg-gray-50 rounded-xl p-6">
							<h3 class="text-xl font-semibold text-gray-900 mb-3">What builder is constructing Heritage at Stonebridge?</h3>
							<p class="text-gray-700">
								...
								construction, innovative floor plans, and comprehensive warranties. Their "Everything's 
								Included" approach means premium features come standard with every home.
							</p>
						</div>
					</div>
				</div>
