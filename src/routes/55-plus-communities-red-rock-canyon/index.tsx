		...
		<>
				...
				<div class="relative max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto">
							Discover luxury active adult living at Heritage at Stonebridge,
							Summerlin's most prestigious 55+ community. Experience
							resort-style amenities, gated security, and breathtaking Red Rock
							Canyon views.
						</p>
					...
					<div class="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							<h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
								Why Heritage at Stonebridge is Las Vegas's Top-Rated 55+
								Community
							</h2>
							<p class="text-lg text-gray-700 mb-6">
								Heritage at Stonebridge represents the pinnacle of luxury 55+
								living in Las Vegas. As one of the most sought-after active
								adult communities near Red Rock Canyon, our gated community
								offers an unparalleled lifestyle for discerning homeowners.
							</p>
							<div class="space-y-4">
								<div class="flex items-start">
									...
									<div>
										...
										<p class="text-gray-600">
											Three distinct collections: Cromwell, Stirling, and
											Evander
										</p>
									</div>
								</div>
								<div class="flex items-start">
									...
									<div>
										...
										<p class="text-gray-600">
											24/7 security with controlled access and professional
											monitoring
										</p>
									</div>
								</div>
								<div class="flex items-start">
									...
									<div>
										...
										<p class="text-gray-600">
											8,000 sq ft clubhouse, pickleball courts, pools, and
											fitness center
										</p>
									</div>
								</div>
						...
						<div class="relative">
							...
							<div class="absolute bottom-6 left-6 text-white">
								...
								<p class="text-sm">
									Experience the finest in active adult community living
								</p>
							</div>
						</div>
					</div>
			...
			<section class="py-16 bg-gray-50">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						<h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
							Unmatched Location: Minutes from Red Rock Canyon & Downtown
							Summerlin
						</h2>
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Heritage at Stonebridge's prime location in Summerlin West offers
							the perfect balance of natural beauty and urban convenience,
							making it one of the most desirable 55+ communities near Red Rock
							Canyon Las Vegas.
						</p>
					</div>
					...
					<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div class="bg-white rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-600 mb-4">
								Just 15 minutes to world-famous Red Rock Canyon National
								Conservation Area
							</p>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-600 mb-4">
								Premium shopping, dining, and entertainment at Downtown
								Summerlin
							</p>
			...
			<section class="py-16 bg-white">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Heritage at Stonebridge offers three carefully designed home
							collections, each tailored to different lifestyles and
							preferences. From intimate single-story designs to spacious luxury
							estates, find your perfect 55+ home for sale in Summerlin.
						</p>
					</div>
					...
					<div class="grid lg:grid-cols-3 gap-8">
						...
						<div class="bg-gray-50 rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-700 mb-4">
								Perfect for those seeking intimate, low-maintenance living with
						...
						<div class="bg-gray-50 rounded-xl p-6 shadow-lg border-2 border-blue-200">
							...
							<p class="text-gray-700 mb-4">
								The perfect balance of space and luxury, featuring open-concept
								designs and premium finishes throughout.
							</p>
							<div class="space-y-2 mb-6">
								<div class="flex justify-between">
									<span class="text-gray-600">Square Feet:</span>
						...
						<div class="bg-gray-50 rounded-xl p-6 shadow-lg">
							...
							<p class="text-gray-700 mb-4">
								Ultimate luxury living with expansive layouts, premium features,
			...
			<section class="py-16 bg-gradient-to-br from-blue-50 to-indigo-100">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Experience the ultimate in gated 55+ communities with amenities
							designed to enhance your active adult lifestyle. From fitness and
							recreation to social gatherings, Heritage at Stonebridge offers
							everything you need for vibrant living.
						</p>
					</div>
					...
					<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">
								Spacious gathering areas, meeting rooms, and event spaces for
						...
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">
								Multiple courts for America's fastest-growing sport among active
								adults
							</p>
						</div>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">
								State-of-the-art equipment and group fitness classes
							</p>
						</div>
						...
						<div class="bg-white rounded-xl p-6 shadow-lg text-center">
							...
							<p class="text-gray-600">
								Gated entrance with professional security monitoring
							</p>
						</div>
					</div>
			...
			<section class="py-16 bg-white">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Heritage at Stonebridge represents not just a lifestyle choice,
							but a smart real estate investment in one of Las Vegas's most
							desirable and stable markets.
						</p>
					</div>
							...
							<div class="space-y-6">
								<div class="bg-green-50 border-l-4 border-green-500 p-6">
									...
									<p class="text-gray-700 mb-2">
										Summerlin properties have shown consistent appreciation over
										the past decade:
									</p>
								...
								<div class="bg-purple-50 border-l-4 border-purple-500 p-6">
									...
									<ul class="text-gray-700 space-y-1">
										<li>
											• Proximity to Red Rock Canyon increases desirability
										</li>
										<li>
											• Summerlin West continues to develop and appreciate
										</li>
			...
			<section class="py-16 bg-gray-50">
				<div class="max-w-7xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700 max-w-3xl mx-auto">
							Heritage at Stonebridge is perfectly positioned within Stonebridge
							Village, offering easy access to world-class amenities,
							entertainment, and services that make Summerlin West one of Las
							Vegas's most sought-after areas.
						</p>
					</div>
				...
				<div class="max-w-4xl mx-auto px-4">
					<div class="text-center mb-12">
						...
						<p class="text-lg text-gray-700">
							Get answers to the most common questions about our 55+ community
					...
					<div class="space-y-6">
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700">
								Heritage at Stonebridge is designed for active adults aged 55
								and older. At least one resident in each household must be 55 or
								older, while spouses or partners can be 45 or older. This age
								restriction ensures a community of like-minded individuals
						...
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700 mb-3">
								Home prices at Heritage at Stonebridge vary by collection and
								floor plan:
							</p>
							...
							<p class="text-gray-700 mt-3">
								Prices include premium finishes, energy-efficient features, and
						...
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700 mb-3">
								Residents enjoy access to a comprehensive suite of resort-style
								amenities:
							</p>
							<ul class="text-gray-700 space-y-1 ml-4">
								<li>
									• 8,000 sq ft clubhouse with meeting rooms and event spaces
								</li>
						...
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700">
								Yes, Heritage at Stonebridge is a fully gated community with
								controlled access and 24/7 security monitoring. The gated
								entrance provides residents with peace of mind and ensures that
								only authorized visitors can enter the community. Professional
						...
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700 mt-3">
								This fee covers exterior maintenance, landscaping, clubhouse
								access, security, common area utilities, and reserve funds for
								future improvements.
							</p>
						</div>
						...
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700">
								Heritage at Stonebridge is located just 12 miles (approximately
								15 minutes) from Red Rock Canyon National Conservation Area.
								This proximity allows residents to easily enjoy hiking, rock
								climbing, scenic drives, and the natural beauty of one of
						...
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700">
								Heritage at Stonebridge is scheduled for completion in 2025. The
								community will feature 421 luxury homes across 50 acres, with
								construction progressing in phases. Early buyers can secure
								their preferred lot locations and customize their homes with
						...
						<div class="bg-gray-50 rounded-xl p-6">
							...
							<p class="text-gray-700">
								Heritage at Stonebridge is being developed by Lennar
								Corporation, one of America's leading homebuilders with over 65
								years of experience. Lennar is known for quality construction,
								innovative floor plans, and comprehensive warranties. Their
								"Everything's Included" approach means premium features come
								standard with every home.
							</p>
						</div>
					</div>
				</div>
			...
			<section class="py-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
				<div class="max-w-7xl mx-auto px-4 text-center">
					...
					<p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
						Join the waitlist for Heritage at Stonebridge and be among the first
						to experience Summerlin's most prestigious active adult community.
...
export const head: DocumentHead = {
	...
	meta: [
		...
		},
		{
			property: "og:title",
			content:
				"55+ Communities Red Rock Canyon Las Vegas | Active Adult Living",
		},
		{
		...
		},
		{
			property: "og:url",
			content:
				"https://heritagestonebridge.com/55-plus-communities-red-rock-canyon",
		},
		{
			property: "og:image",
			content:
