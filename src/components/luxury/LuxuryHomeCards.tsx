...
const homeCards: HomeCard[] = [
	{
		...
		features: ["Granite Countertops", "Stainless Appliances", "Hardwood Floors", "Energy Efficient"],
		floorPlan: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
