...
export const SortOptions = component$<SortOptionsProps>(({ sortBy, sortOrder, onSortChange$ }) => {
	...
	return (
		<div class="flex items-center space-x-4">
			...
			<select
				...
				value={sortBy}
				onChange$={(e) => {
					handleSortByChange((e.target as HTMLSelectElement).value as "price" | "beds" | "sqft" | "newest");
				}}
